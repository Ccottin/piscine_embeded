...
void    i2c_transmitter_send(uint8_t rec_adr) {
    i2c_write(rec_adr << 1);
}

void    i2c_transmitter_receive(uint8_t rec_adr) {
    i2c_write(rec_adr << 1 | 1);
}
